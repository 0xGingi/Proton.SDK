namespace Proton.Sdk.Drive.IO;

/// <summary>
/// Wrapper that cancels disposal of a <see cref="Stream"/> object>.
/// </summary>
/// <remarks>
/// This is useful in case a stream consumer such as <see cref="StreamContent"/> always disposes/closes a stream with no option to leave it open for re-use or for getting its position or length
/// </remarks>
